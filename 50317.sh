...
upgrade_db() {
crontab -l | grep -q "/opt/cdnfly/master/sh/monitor_task.sh" || (crontab -l ; echo '* * * * *  bash /opt/cdnfly/master/sh/monitor_task.sh') | crontab -


# 更新panel或conf
# chattr -iR /opt/cdnfly/master/
