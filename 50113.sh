...
download "https://dl2.cdnfly.cn/cdnfly/$tar_gz_name" "https://us.centos.bz/cdnfly/$tar_gz_name" "https://github.com/freejbgo/cdnfly-kaixin/blob/main/cdnfly/$tar_gz_name" "$tar_gz_name"
echo "下载完成"
